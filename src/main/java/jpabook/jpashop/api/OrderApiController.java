...
public class OrderApiController {
    ...
    public List<OrderQueryDto> ordersV6() {
        ...
        return flats.stream()
                ...
                .map(orderItemQueryDtos -> new OrderQueryDto(orderItemQueryDtos.getOrderId(),
                        orderItemQueryDtos.getName(), orderItemQueryDtos.getOrderDate(), orderItemQueryDtos.getOrderStatus(),
                        orderItemQueryDtos.getAddress()))
                .collect(toList());
    }
